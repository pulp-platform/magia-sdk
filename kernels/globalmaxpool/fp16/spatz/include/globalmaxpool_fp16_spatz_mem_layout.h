#ifndef GLOBALMAXPOOL_FP16_SPATZ_MEM_LAYOUT_H_
#define GLOBALMAXPOOL_FP16_SPATZ_MEM_LAYOUT_H_
...
#define GLOBALMAXPOOL_FP16_SPATZ_PARAMS_BASE   (L1_BASE_TILE)
#define GLOBALMAXPOOL_FP16_SPATZ_PARAMS_SIZE   ALIGN_4B(sizeof(globalmaxpool_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(GLOBALMAXPOOL_FP16_SPATZ_PARAMS_BASE + GLOBALMAXPOOL_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* GLOBALMAXPOOL_FP16_SPATZ_MEM_LAYOUT_H_ */
