#ifndef GELU_FP16_MEM_LAYOUT_H_
#define GELU_FP16_MEM_LAYOUT_H_
...
#define GELU_FP16_SPATZ_PARAMS_BASE  (L1_BASE_TILE)
#define GELU_FP16_SPATZ_PARAMS_SIZE  ALIGN_4B(sizeof(gelu_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(GELU_FP16_SPATZ_PARAMS_BASE + GELU_FP16_SPATZ_PARAMS_SIZE)
