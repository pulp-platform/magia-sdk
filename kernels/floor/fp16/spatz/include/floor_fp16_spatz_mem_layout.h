#ifndef FLOOR_FP16_SPATZ_MEM_LAYOUT_H_
#define FLOOR_FP16_SPATZ_MEM_LAYOUT_H_
...
#define FLOOR_FP16_SPATZ_PARAMS_BASE    (L1_BASE_TILE)
#define FLOOR_FP16_SPATZ_PARAMS_SIZE    ALIGN_4B(sizeof(floor_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(FLOOR_FP16_SPATZ_PARAMS_BASE + FLOOR_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* FLOOR_FP16_SPATZ_MEM_LAYOUT_H_ */
