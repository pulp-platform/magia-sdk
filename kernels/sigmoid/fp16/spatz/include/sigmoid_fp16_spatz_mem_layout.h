#ifndef SIGMOID_FP16_MEM_LAYOUT_H_
#define SIGMOID_FP16_MEM_LAYOUT_H_
...
#define SIGMOID_FP16_SPATZ_PARAMS_BASE  (L1_BASE_TILE)
#define SIGMOID_FP16_SPATZ_PARAMS_SIZE  ALIGN_4B(sizeof(sigmoid_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(SIGMOID_FP16_SPATZ_PARAMS_BASE + SIGMOID_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* SIGMOID_FP16_MEM_LAYOUT_H_ */
