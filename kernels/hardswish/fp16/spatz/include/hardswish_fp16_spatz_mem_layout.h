#ifndef HARDSWISH_FP16_MEM_LAYOUT_H_
#define HARDSWISH_FP16_MEM_LAYOUT_H_
...
#define HARDSWISH_FP16_SPATZ_PARAMS_BASE  (L1_BASE_TILE)
#define HARDSWISH_FP16_SPATZ_PARAMS_SIZE  ALIGN_4B(sizeof(hardswish_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(HARDSWISH_FP16_SPATZ_PARAMS_BASE + HARDSWISH_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* HARDSWISH_FP16_MEM_LAYOUT_H_ */
