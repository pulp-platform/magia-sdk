#ifndef DIV_FP16_MEM_LAYOUT_H_
#define DIV_FP16_MEM_LAYOUT_H_
...
#define DIV_FP16_SPATZ_PARAMS_BASE  (L1_BASE_TILE)
#define DIV_FP16_SPATZ_PARAMS_SIZE  ALIGN_4B(sizeof(div_fp16_spatz_params_t))

#define SHARD_A_BASE    ALIGN_4B(DIV_FP16_SPATZ_PARAMS_BASE + DIV_FP16_SPATZ_PARAMS_SIZE)
