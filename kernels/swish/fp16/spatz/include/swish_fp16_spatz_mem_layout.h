#ifndef SWISH_FP16_MEM_LAYOUT_H_
#define SWISH_FP16_MEM_LAYOUT_H_
...
#define SWISH_FP16_SPATZ_PARAMS_BASE  (L1_BASE_TILE)
#define SWISH_FP16_SPATZ_PARAMS_SIZE  ALIGN_4B(sizeof(swish_fp16_spatz_params_t))

#define SHARD_X_BASE    ALIGN_4B(SWISH_FP16_SPATZ_PARAMS_BASE + SWISH_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* SWISH_FP16_MEM_LAYOUT_H_ */
