...
#define ADD_FP16_SPATZ_PARAMS_BASE    (L1_BASE_TILE)
#define ADD_FP16_SPATZ_PARAMS_SIZE    ALIGN_4B(sizeof(add_fp16_spatz_params_t))

#define SHARD_A_BASE    ALIGN_4B(ADD_FP16_SPATZ_PARAMS_BASE + ADD_FP16_SPATZ_PARAMS_SIZE)
