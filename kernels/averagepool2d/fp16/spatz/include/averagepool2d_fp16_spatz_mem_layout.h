#ifndef AVERAGEPOOL2D_FP16_SPATZ_MEM_LAYOUT_H_
#define AVERAGEPOOL2D_FP16_SPATZ_MEM_LAYOUT_H_
...
#define AVERAGEPOOL2D_FP16_SPATZ_PARAMS_BASE    (L1_BASE_TILE)
#define AVERAGEPOOL2D_FP16_SPATZ_PARAMS_SIZE    ALIGN_4B(sizeof(averagepool2d_fp16_spatz_params_t))

#define SHARD_X_BASE        ALIGN_4B(AVERAGEPOOL2D_FP16_SPATZ_PARAMS_BASE + AVERAGEPOOL2D_FP16_SPATZ_PARAMS_SIZE)
...
#endif  /* AVERAGEPOOL2D_FP16_SPATZ_MEM_LAYOUT_H_ */
