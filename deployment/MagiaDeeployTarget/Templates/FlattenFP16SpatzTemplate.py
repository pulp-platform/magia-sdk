...
class _MagiaFlattenFP16Spatz(NodeTemplate):
...
referenceTemplate = _MagiaFlattenFP16Spatz("""
// Magia Flatten FP16 Spatz (Name: ${nodeName}, Op: ${nodeOp}) -- no-op: ${data_out} aliases ${data_in}
