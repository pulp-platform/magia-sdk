...
class _MagiaTanhFP16Spatz(NodeTemplate):
...
referenceTemplate = _MagiaTanhFP16Spatz("""
// Magia Tanh FP 16 Spatz (Name: ${nodeName}, Op: ${nodeOp})
#ifdef ENABLE_NODE_LOGS
printf("[CV32 (%d)] Running node: ${nodeName} (${nodeOp})\\n", get_hartid());
#endif
MAGIA_tanh_fp16_spatz(${data_in}, ${data_out}, ${size});
""")
