...
from MagiaDeeployTarget.Templates import FlattenFP16SpatzTemplate
...
from MagiaDeeployTarget.Templates import ReduceMeanFP16SpatzTemplate
...
MagiaFlattenFp16Bindings = [
    NodeBinding(
        DummyChecker(
            [PointerClass(float16_t)],
            [PointerClass(float16_t)]
        ),
        FlattenFP16SpatzTemplate.referenceTemplate,
        BasicTransformer,
    )
]
...
MagiaReduceMeanFp16Bindings = [
    NodeBinding(
        ReduceMeanChecker(
            [PointerClass(float16_t)],
            [PointerClass(float16_t)]
        ),
        ReduceMeanFP16SpatzTemplate.referenceTemplate,
        BasicTransformer,
    )
]
