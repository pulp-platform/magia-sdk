...
uint32_t __attribute__((used, visibility("default")))
eu_redmule_wait(eu_controller_t *ctrl, eu_wait_mode_t mode)
{
...
uint32_t __attribute__((used, visibility("default")))
eu_idma_wait_a2o(eu_controller_t *ctrl, eu_wait_mode_t mode)
{
    return eu32_idma_wait_a2o(ctrl, mode);
}
uint32_t __attribute__((used, visibility("default")))
eu_idma_wait_o2a(eu_controller_t *ctrl, eu_wait_mode_t mode)
{
