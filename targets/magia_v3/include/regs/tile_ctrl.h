...
// Pulp cluster Events [13:12] - pulp_events_i mapping
#define EU_PULP_DONE_BIT              (12)         // Pulp end of compute
#define EU_PULP_START_BIT             (13)         // Pulp task dispatch IRQ
#define EU_PULP_EVT_MASK              (0x00003000) // bits 13:12
...
#define IDMA_SRC_ADDR_LOW_ADDR(is_l1_to_l2)                                                        \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_SRC_ADDR_LOW_OFFSET)                                \
                   : (IDMA_BASE_AXI2OBI + IDMA_SRC_ADDR_LOW_OFFSET))
#define IDMA_LENGTH_LOW_ADDR(is_l1_to_l2)                                                          \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_LENGTH_LOW_OFFSET)                                  \
                   : (IDMA_BASE_AXI2OBI + IDMA_LENGTH_LOW_OFFSET))
#define IDMA_DST_STRIDE_2_LOW_ADDR(is_l1_to_l2)                                                    \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_DST_STRIDE_2_LOW_OFFSET)                            \
                   : (IDMA_BASE_AXI2OBI + IDMA_DST_STRIDE_2_LOW_OFFSET))
#define IDMA_SRC_STRIDE_2_LOW_ADDR(is_l1_to_l2)                                                    \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_SRC_STRIDE_2_LOW_OFFSET)                            \
                   : (IDMA_BASE_AXI2OBI + IDMA_SRC_STRIDE_2_LOW_OFFSET))
#define IDMA_REPS_2_LOW_ADDR(is_l1_to_l2)                                                          \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_REPS_2_LOW_OFFSET)                                  \
                   : (IDMA_BASE_AXI2OBI + IDMA_REPS_2_LOW_OFFSET))
#define IDMA_DST_STRIDE_3_LOW_ADDR(is_l1_to_l2)                                                    \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_DST_STRIDE_3_LOW_OFFSET)                            \
                   : (IDMA_BASE_AXI2OBI + IDMA_DST_STRIDE_3_LOW_OFFSET))
#define IDMA_SRC_STRIDE_3_LOW_ADDR(is_l1_to_l2)                                                    \
    ((is_l1_to_l2) ? (IDMA_BASE_OBI2AXI + IDMA_SRC_STRIDE_3_LOW_OFFSET)                            \
                   : (IDMA_BASE_AXI2OBI + IDMA_SRC_STRIDE_3_LOW_OFFSET))
