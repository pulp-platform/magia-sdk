#ifndef ONNX_LAYERNORM_H_
#define ONNX_LAYERNORM_H_
...
#define ONNX_LAYERNORM_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_LAYERNORM_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_layernorm_params_t))

#define GAMMA_BASE  ALIGN_4B(ONNX_LAYERNORM_PARAMS_BASE + ONNX_LAYERNORM_PARAMS_SIZE)
