#ifndef ONNX_GROUPNORM_H_
#define ONNX_GROUPNORM_H_
...
#define ONNX_GROUPNORM_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_GROUPNORM_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_groupnorm_params_t))

#define GAMMA_BASE  ALIGN_4B(ONNX_GROUPNORM_PARAMS_BASE + ONNX_GROUPNORM_PARAMS_SIZE)
