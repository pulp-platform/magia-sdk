#ifndef ONNX_FLOOR_H_
#define ONNX_FLOOR_H_
...
#define ONNX_FLOOR_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_FLOOR_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_floor_params_t))

#define CHUNK_X_BASE    ALIGN_4B(ONNX_FLOOR_PARAMS_BASE + ONNX_FLOOR_PARAMS_SIZE)
