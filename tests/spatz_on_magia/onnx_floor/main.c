...
static int init_data(void *params)
{
    ...
    floor_params->addr_input = INPUT_BASE;
    floor_params->addr_res = RES_BASE;
    floor_params->addr_exp = EXP_BASE;
...
static bool check_result(void *params)
{
    volatile onnx_floor_params_t *floor_params;
    floor_params = (volatile onnx_floor_params_t *) params;
    return vector_compare_fp16_bitwise(floor_params->addr_res, floor_params->addr_exp, floor_params->len);
}
