...
def parse_args():
    parser = argparse.ArgumentParser(description="Generator of Input Data and Golden Model for ONNX Floor test")
...
def run_onnx_floor(input):
    ...
    node_def = onnx.helper.make_node('Floor', ['I'], ['O'])
    graph_def = onnx.helper.make_graph([node_def], 'onnx-floor-test', [input_info], [output_info])
