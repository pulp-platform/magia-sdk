...
/*
 * Shim so kernels/spatz_fp16/add/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including ADD_FP16_SPATZ_TASK. So redirecting the per-kernel
