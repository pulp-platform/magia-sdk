...
/*
 * Shim so kernels/spatz_fp16/softmax/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including SOFTMAX_FP16_SPATZ_TASK. So redirecting the per-kernel
