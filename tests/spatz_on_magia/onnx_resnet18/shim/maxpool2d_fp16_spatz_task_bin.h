...
/*
 * Shim so kernels/spatz_fp16/maxpool2d/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including MAXPOOL2D_FP16_SPATZ_TASK. So redirecting the per-kernel
