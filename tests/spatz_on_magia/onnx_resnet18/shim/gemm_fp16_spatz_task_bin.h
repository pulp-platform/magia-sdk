...
/*
 * Shim so kernels/spatz_fp16/gemm/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including GEMM_FP16_SPATZ_TASK. So redirecting the per-kernel
