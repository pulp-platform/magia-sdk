...
/*
 * Shim so kernels/spatz_fp16/conv2dgemm/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including CONV2DGEMM_FP16_SPATZ_TASK. So redirecting the per-kernel
