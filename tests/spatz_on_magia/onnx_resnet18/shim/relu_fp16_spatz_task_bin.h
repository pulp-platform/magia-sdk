...
/*
 * Shim so kernels/spatz_fp16/relu/src can be compiled unmodified into this test.
 *
 ...
 * symbol it finds - including RELU_FP16_SPATZ_TASK. So redirecting the per-kernel
