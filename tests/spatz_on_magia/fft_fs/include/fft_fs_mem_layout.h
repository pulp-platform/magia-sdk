...
#define CHUNK_A_BASE    ALIGN_4B(FFT_PARAMS_BASE + FFT_PARAMS_SIZE)
...
#define CHUNK_W_BASE    ALIGN_4B(CHUNK_B_BASE + CHUNK_B_SIZE)
#define CHUNK_W_SIZE    ALIGN_4B(OUT_CHUNK_SIZE)

#define CHUNK_C_BASE    ALIGN_4B(CHUNK_W_BASE + CHUNK_W_SIZE)
