#ifndef ONNX_INSTANCENORM_H_
#define ONNX_INSTANCENORM_H_
...
#define ONNX_INSTANCENORM_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_INSTANCENORM_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_instancenorm_params_t))

#define GAMMA_BASE  ALIGN_4B(ONNX_INSTANCENORM_PARAMS_BASE + ONNX_INSTANCENORM_PARAMS_SIZE)
#define GAMMA_SIZE  ALIGN_4B(SCALAR_SIZE)

#define BETA_BASE   ALIGN_4B(GAMMA_BASE + GAMMA_SIZE)
#define BETA_SIZE   ALIGN_4B(SCALAR_SIZE)

#define INPUT_BASE  ALIGN_4B(BETA_BASE + BETA_SIZE)
