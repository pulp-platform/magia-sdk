#ifndef ONNX_GLOBALAVERAGEPOOL_H_
#define ONNX_GLOBALAVERAGEPOOL_H_
...
#define ONNX_GLOBALAVERAGEPOOL_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_GLOBALAVERAGEPOOL_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_globalaveragepool_params_t))

#define INPUT_BASE  ALIGN_4B(ONNX_GLOBALAVERAGEPOOL_PARAMS_BASE + ONNX_GLOBALAVERAGEPOOL_PARAMS_SIZE)
...
#endif  /* ONNC_GLOBALAVERAGEPOOL_H_ */
