...
def parse_args():
    parser = argparse.ArgumentParser(description="Generator of Input Data and Golden Model for ONNX Ceil test")
...
def run_onnx_ceil(input):
    ...
    node_def = onnx.helper.make_node('Ceil', ['I'], ['O'])
    graph_def = onnx.helper.make_graph([node_def], 'onnx-ceil-test', [input_info], [output_info])
