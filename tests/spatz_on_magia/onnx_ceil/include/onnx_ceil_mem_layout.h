...
#define ONNX_CEIL_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_CEIL_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_ceil_params_t))

#define CHUNK_X_BASE    ALIGN_4B(ONNX_CEIL_PARAMS_BASE + ONNX_CEIL_PARAMS_SIZE)
