#ifndef ONNX_SIGMOID_H_
#define ONNX_SIGMOID_H_
...
#define ONNX_SIGMOID_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_SIGMOID_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_sigmoid_params_t))

#define CHUNK_X_BASE    ALIGN_4B(ONNX_SIGMOID_PARAMS_BASE + ONNX_SIGMOID_PARAMS_SIZE)
