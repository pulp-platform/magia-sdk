#ifndef ONNX_SWISH_H_
#define ONNX_SWISH_H_
...
#define ONNX_SWISH_PARAMS_BASE    (L1_BASE_TILE)
#define ONNX_SWISH_PARAMS_SIZE    ALIGN_4B(sizeof(onnx_swish_params_t))

#define CHUNK_X_BASE    ALIGN_4B(ONNX_SWISH_PARAMS_BASE + ONNX_SWISH_PARAMS_SIZE)
