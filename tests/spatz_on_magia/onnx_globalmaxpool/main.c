...
#include "data.h"
#include "onnx_globalmaxpool_mem_layout.h"
#include "onnx_globalmaxpool_params.h"
#include "onnx_globalmaxpool_task_bin.h"

static int init_data(void *params)
{
    uint32_t offset;
    volatile onnx_globalmaxpool_params_t *avgpool_params;

    avgpool_params = (volatile onnx_globalmaxpool_params_t *) params;
...
static int run_spatz_task()
{
    ...
    spatz_run_task_with_params(ONNX_GLOBALMAXPOOL_TASK, ONNX_GLOBALMAXPOOL_PARAMS_BASE);
...
static bool run_test()
{
    int ret;
    bool check;
    volatile onnx_globalmaxpool_params_t *params;

    params = (volatile onnx_globalmaxpool_params_t *) ONNX_GLOBALMAXPOOL_PARAMS_BASE;
