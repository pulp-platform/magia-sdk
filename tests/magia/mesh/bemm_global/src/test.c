...
#define INITIAL_BIT (sqrt(MESH_X_TILES))
...
/**
 * This test implements an optimized GeMM algorithm for MAGIA based on the Benes communication pattern - The BeMM. 
 */
int main(void){
    ...
    /**
     * The BeMM is implemented with the number of timeslots equal to the mesh dimension.
     */
#if defined(SIZE_64x64x64)
    uint8_t timeslots = 2;
#elif defined(SIZE_128x128x128)
