...
3. DMA full `M5[E × F]` from L2 into L1.
4. Zero the L1 accumulator buffer for `O_slice`.
5. RedMulE GEMM: `O_slice = R3_slice @ M5`.
6. DMA `O_slice` back to L2 at `o_out[start_row * F]`.
